...
NJS_MATERIAL matlist_0017A60C[] = {
	{ { 0xFFB2B2B2 }, { 0x00000000 }, 0, 4, NJD_D_100 | NJD_FLAG_CLAMP_V | NJD_FLAG_CLAMP_U | NJD_FLAG_USE_TEXTURE | NJD_FLAG_IGNORE_LIGHT | NJD_DA_INV_SRC | NJD_SA_SRC },
	{ { 0xFFB2B2B2 }, { 0x00000000 }, 0, 2, NJD_D_100 | NJD_FLAG_CLAMP_V | NJD_FLAG_USE_TEXTURE | NJD_FLAG_IGNORE_LIGHT | NJD_DA_INV_SRC | NJD_SA_SRC },
	{ { 0xFFB2B2B2 }, { 0x00000000 }, 0, 2, NJD_D_100 | NJD_FLAG_CLAMP_V | NJD_FLAG_USE_TEXTURE | NJD_FLAG_IGNORE_LIGHT | NJD_DA_INV_SRC | NJD_SA_SRC },
	...
	{ { 0xFFB2B2B2 }, { 0x00000000 }, 0, 0, NJD_D_025 | NJD_FLAG_CLAMP_U | NJD_FLAG_USE_TEXTURE | NJD_FLAG_IGNORE_LIGHT | 0x1 }
};
...
NJS_MESHSET_SADX meshlist_0017A8B4[] = {
	...
	{ NJD_MESHSET_TRIMESH | 4, 2, poly_0017A6F2, NULL, NULL, NULL, uv_0017A7F4, NULL },
	{ NJD_MESHSET_TRIMESH | 5, 2, poly_0017A716, NULL, NULL, NULL, uv_0017A834, NULL },
	{ NJD_MESHSET_TRIMESH | 6, 4, poly_0017A73A, NULL, NULL, NULL, uv_0017A874, NULL }
};
...
NJS_MATERIAL matlist_0017ACB8[] = {
	{ { 0xFFB2B2B2 }, { 0x00000000 }, 0, 1, NJD_D_100 | NJD_FLAG_CLAMP_U | NJD_FLAG_USE_TEXTURE | NJD_FLAG_IGNORE_LIGHT | NJD_DA_INV_SRC | NJD_SA_SRC },
